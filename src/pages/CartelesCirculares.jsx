                    ...
                    <div className="row mt-50">
                        ...
                        <div className="col-xl-5 col-md-12">
                            <div className="block-text">
                                ...
                                <p className="fs-18"> Algunos trabajos en carteles circulares con frente de acrílico, contorno de chapa e iluminación Led para un menor consumo de electricidad. Ideal para señalización de entradas o señalización con saliente a la vereda. </p>
