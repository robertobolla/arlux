                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="block-text center">
                                ...
                                <h3 className="title mb-28" data-aos="fade-up" data-aos-duration="1000">Lona Impresa</h3>
                            </div>
                        </div>
                    </div>
                    <div className="row mt-50">
                        ...
                        <div className="col-xl-5 col-md-12">
                            <div className="block-text">
                                ...
                                <p className="fs-18"> Algunos trabajos en lona impresa, con caño estuctural y marcos con chapa plegada. En el caso de los que tienen iluminación, usamos tecnología Led para un menor consumo de electricidad. </p>
                                ...
                                <ul className="nft">
                                    ...
                                    <li><Link to="/corporea-chapa"><i className="fa fa-arrow-right"></i><span>Corpóras de Chapa</span></Link></li>
                                    <li><Link to="/corporea-polifan"><i className="fa fa-arrow-right"></i><span>Corpóras de Polifán</span></Link></li>
